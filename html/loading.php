  ...
  <body>
        <div class="container">
            <div class="col-md-12">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a href="bicycode.php" class="btn btn-info">Bicycode</a>
                    </li>
                </ul>
...
$req_all_records = $bdd->prepare('SELECT bicycode, nom_client, numero_commande, commentaire FROM multipath');
$req_all_records->execute();

echo "<div class='container'>";

echo "<table class='table'>";
echo "<thead><tr><th>Bicycode</th><th>Nom du client</th><th>Numéro de commande</th><th>Commentaire</th><th>Statut SAV</th></tr></thead>";
echo "<tbody>";
...
while ($data_all_records = $req_all_records->fetch()) {
    ...
    echo "<tr>";
    echo "<td>". $data_all_records['bicycode'] ."</td>";
