...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <h2>Enregistrer un vélo pour un particulier</h2>
            </div>
        </div>
    ...
    <div class="form-group">
        ...
        <input type="checkbox"  name="isElectric" id="isElectric" checked><br>
        </div>
        ...
        <input type="text" class="form-control" name="siret" id="siret" required value="90760519000020"><br>
        </div>
